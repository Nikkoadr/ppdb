...
<body>
    <div class="page">
        ...
        <div style="text-align:left; margin:15px auto 20px auto">
            ...
            <b style="font-size:10pt !important;">Daftar pada : {{ \Carbon\Carbon::parse($pendaftaran->created_at)->translatedFormat('d F Y') }}</b>
        </div>
...
$(document).ready(function() {
    Swal.fire({
        ...
        text: "Simpan Bukti Pendaftaran Anda untuk diserahkan ke Panitia PPDB",
        icon: "success"
    });
});
</script>
