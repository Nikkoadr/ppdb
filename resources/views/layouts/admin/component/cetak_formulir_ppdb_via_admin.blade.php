...
<body>
        ...
        <div style="text-align:left; margin:20px auto 20px auto">
            <b style="font-size:14pt !important;">ID Pendaftaran : {{ $user -> id }}</b><br>
            <b style="font-size:10pt !important;">Daftar pada : {{\Carbon\Carbon::parse( $user -> created_at )->translatedFormat('d F Y')}}</b>
        </div>
